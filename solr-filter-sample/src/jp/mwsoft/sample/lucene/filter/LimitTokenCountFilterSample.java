...
public class LimitTokenCountFilterSample {

	public static void main(String[] args) throws Exception {

		MyAnalyzer analyzer = new MyAnalyzer();

		String str = "Abraham begat Isaac; and Isaac begat Jacob; and Jacob begat Judas and his brethren; ";
	...
	static class MyAnalyzer extends Analyzer {
		public final TokenStream tokenStream(String fieldName, Reader reader) {
			...
			result = new LimitTokenCountFilter(result, 10);
			return result;
		}
	}
}