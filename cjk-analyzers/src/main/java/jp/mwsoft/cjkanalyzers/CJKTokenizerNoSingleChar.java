 ...
 * 
 */
public final class CJKTokenizerNoSingleChar extends Tokenizer {
	 ...
	 *            I/O reader
	 */
	public CJKTokenizerNoSingleChar(Reader in) {
		super(in);
	}

	public CJKTokenizerNoSingleChar(AttributeSource source, Reader in) {
		super(source, in);
	}

	public CJKTokenizerNoSingleChar(AttributeFactory factory, Reader in) {
		super(factory, in);
	}
