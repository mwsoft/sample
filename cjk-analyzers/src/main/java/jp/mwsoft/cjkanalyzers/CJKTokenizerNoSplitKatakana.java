 ...
 * 
 */
public final class CJKTokenizerNoSplitKatakana extends Tokenizer {
	 ...
	 *            I/O reader
	 */
	public CJKTokenizerNoSplitKatakana(Reader in) {
		super(in);
	}

	public CJKTokenizerNoSplitKatakana(AttributeSource source, Reader in) {
		super(source, in);
	}

	public CJKTokenizerNoSplitKatakana(AttributeFactory factory, Reader in) {
		super(factory, in);
	}
