 ...
 * 
 */
public final class CJKTokenizerNoSingleCharNoSplitKatakana extends Tokenizer {
	...
	/** KATAKANA token type */
	static final int KATAKANA_TOKEN_TYPE = 3;

	/** Names for token types */
	static final String[] TOKEN_TYPE_NAMES = { "word", "single", "double", "katakana" };
	 ...
	 *            I/O reader
	 */
	public CJKTokenizerNoSingleCharNoSplitKatakana(Reader in) {
		super(in);
	}

	public CJKTokenizerNoSingleCharNoSplitKatakana(AttributeSource source, Reader in) {
		super(source, in);
	}

	public CJKTokenizerNoSingleCharNoSplitKatakana(AttributeFactory factory, Reader in) {
		super(factory, in);
	}
				...
				if ((ub == Character.UnicodeBlock.KATAKANA)) {
					...
					if (Character.isLetterOrDigit(c) || ((c == '_') || (c == '+') || (c == '#'))) {
						if (length == 0) {
							...
							// letter
							start = offset - 1;
						} else if (tokenType == DOUBLE_TOKEN_TYPE || tokenType == KATAKANA_TOKEN_TYPE) {
							// "javaC1C2C3C4linux" <br>
					...
					if (Character.isLetter(c)) {
						if (length == 0) {
							...
							if (tokenType == SINGLE_TOKEN_TYPE || tokenType == KATAKANA_TOKEN_TYPE) {
								offset--;
								bufferIndex--;
